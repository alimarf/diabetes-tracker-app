...
mixin _$MealResponse {
  ...
  @JsonKey(name: 'data')
  List<MealData>? get data => throw _privateConstructorUsedError;
...
class _$MealResponseImpl implements _MealResponse {
  _$MealResponseImpl(
      ...
      @JsonKey(name: 'data') final List<MealData>? data})
      : _data = data;
  ...
  final List<MealData>? _data;
  @override
  @JsonKey(name: 'data')
  List<MealData>? get data {
    final value = _data;
  ...
  @override
  String toString() {
    return 'MealResponse(statusCode: $statusCode, message: $message, data: $data)';
  }
...
abstract class _MealResponse implements MealResponse {
  factory _MealResponse(
      {@JsonKey(name: 'status_code') final int? statusCode,
      @JsonKey(name: 'message') final String? message,
      @JsonKey(name: 'data') final List<MealData>? data}) = _$MealResponseImpl;
